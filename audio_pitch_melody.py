...
class AudioPitchMelody():
    
    def __init__(self):
        pass
    
    def extract_audio_pitch_melody(self, song_path, song_audio_features):
        ...
        pitch_extractor = estd.PitchMelodia(frameSize=frame_size, hopSize=hop_size)
